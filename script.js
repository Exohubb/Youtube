...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('paymentdetails').addEventListener('submit', function(event) {
        ...
        // document.querySelector("#paybtn").style.backgroundColor = "red";
        // document.getElementsByTagName("body")[0].style.filter = "blur(0.2rem)";
...
function hidepay(){
    var blur = document.getElementById("mainblur");
    blur.classList.toggle('active')
    var hidecards = document.getElementById("cardhide");
    hidecards.classList.toggle('active')
}
